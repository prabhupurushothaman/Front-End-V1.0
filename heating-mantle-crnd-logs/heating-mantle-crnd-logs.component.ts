...
@Component({
  selector: 'app-heating-mantle-crnd-logs',
  templateUrl: './heating-mantle-crnd-logs.component.html',
  styleUrls: ['./heating-mantle-crnd-logs.component.css']
})
export class HeatingMantleCrndLogsComponent  implements OnInit
{
  dateLabel = "Date";
  ...
  heatingMantleCrndHeadingLabel = "Primas Heating Mantle CRND Logs";
  helpLabel = "Help";
  ...
  public heatingMantleCrndForm!: FormGroup;
...
//  constructor(public fb: FormBuilder,private router:Router, public csService: DataService) { 
  ...
  reactiveForm() {
    this.heatingMantleCrndForm = this.fb.group({
...
//      password: ['', [Validators.required, Validators.minLength, Validators.maxLength]],
  ...
  public  errorMessage(control: string, msg : string): string {
    const form: FormControl = (this.heatingMantleCrndForm.controls[control] as FormControl);
 ...
 save(): void{
  console.log(this.heatingMantleCrndForm.value);
