...
@Component({
  selector: 'app-weighing-balance4-prod-logs',
  templateUrl: './weighing-balance4-prod-logs.component.html',
  styleUrls: ['./weighing-balance4-prod-logs.component.css']
})
export class WeighingBalance4ProdLogsComponent implements OnInit
{
  dateLabel = "Date";
  ...
  weighingBalance4ProdHeadingLabel = "Primas Weighing Balance 4 Prod";
  helpLabel = "Help";
  ...
  public weighingBalance4ProdForm!: FormGroup;
...
//  constructor(public fb: FormBuilder,private router:Router, public csService: DataService) { 
  ...
  reactiveForm() {
    this.weighingBalance4ProdForm = this.fb.group({
...
//      password: ['', [Validators.required, Validators.minLength, Validators.maxLength]],
  ...
  public  errorMessage(control: string, msg : string): string {
    const form: FormControl = (this.weighingBalance4ProdForm.controls[control] as FormControl);
 ...
 save(): void{
  console.log(this.weighingBalance4ProdForm.value);
