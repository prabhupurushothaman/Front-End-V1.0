...
@Component({
  selector: 'app-deep-freezer-minus20c1-bp-logs',
  templateUrl: './deep-freezer-minus20c1-bp-logs.component.html',
  styleUrls: ['./deep-freezer-minus20c1-bp-logs.component.css']
})
export class DeepFreezerMinus20c1BpLogsComponent implements OnInit
{
  dateLabel = "Date";
  ...
  deepFreezerMinus20C1BpHeadingLabel = "Primas Deep Freezer -20C 1 BP Logs";
  helpLabel = "Help";
  ...
  public deepFreezerMinus20C1BpForm!: FormGroup;
...
//  constructor(public fb: FormBuilder,private router:Router, public csService: DataService) { 
  ...
  reactiveForm() {
    this.deepFreezerMinus20C1BpForm = this.fb.group({
...
//      password: ['', [Validators.required, Validators.minLength, Validators.maxLength]],
  ...
  public  errorMessage(control: string, msg : string): string {
    const form: FormControl = (this.deepFreezerMinus20C1BpForm.controls[control] as FormControl);
 ...
 save(): void{
  console.log(this.deepFreezerMinus20C1BpForm.value);
