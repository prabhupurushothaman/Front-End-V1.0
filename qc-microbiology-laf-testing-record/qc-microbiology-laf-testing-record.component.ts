...
@Component({
  selector: 'app-qc-microbiology-laf-testing-record',
  templateUrl: './qc-microbiology-laf-testing-record.component.html',
  styleUrls: ['./qc-microbiology-laf-testing-record.component.css']
})
export class QcMicrobiologyLafTestingRecordComponent implements OnInit
{
  ...
  qcMicrobiologyLafTestingRecordHeadingLabel = "Primas QC Microbiology Laf Testing Record";
  helpLabel = "Help";
  ...
  public qcMicrobiologyLafTestingRecordForm!: FormGroup;
...
//  constructor(public fb: FormBuilder,private router:Router, public csService: DataService) { 
  ...
  reactiveForm() {
    this.qcMicrobiologyLafTestingRecordForm = this.fb.group({
...
//      password: ['', [Validators.required, Validators.minLength, Validators.maxLength]],
  ...
  public  errorMessage(control: string, msg : string): string {
    const form: FormControl = (this.qcMicrobiologyLafTestingRecordForm.controls[control] as FormControl);
  ...
  save(): void{
    console.log(this.qcMicrobiologyLafTestingRecordForm.value);
