...
@Component({
  selector: 'app-autoclave1-logs',
  templateUrl: './autoclave1-logs.component.html',
  styleUrls: ['./autoclave1-logs.component.css']
})
export class Autoclave1LogsComponent implements OnInit
{
  dateLabel = "Date";
  ...
  autoclave1HeadingLabel = "Primas Autoclave 1 Logs";
  helpLabel = "Help";
  ...
  public autoclave1Form!: FormGroup;
...
//  constructor(public fb: FormBuilder,private router:Router, public csService: DataService) { 
  ...
  reactiveForm() {
    this.autoclave1Form = this.fb.group({
...
//      password: ['', [Validators.required, Validators.minLength, Validators.maxLength]],
  ...
  public  errorMessage(control: string, msg : string): string {
    const form: FormControl = (this.autoclave1Form.controls[control] as FormControl);
 ...
 save(): void{
  console.log(this.autoclave1Form.value);
