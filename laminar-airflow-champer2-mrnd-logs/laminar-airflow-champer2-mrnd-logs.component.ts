...
@Component({
  selector: 'app-laminar-airflow-champer2-mrnd-logs',
  templateUrl: './laminar-airflow-champer2-mrnd-logs.component.html',
  styleUrls: ['./laminar-airflow-champer2-mrnd-logs.component.css']
})
export class LaminarAirflowChamper2MrndLogsComponent implements OnInit
{
  dateLabel = "Date";
  ...
  laminarAirflowChamper2MrndHeadingLabel = "Primas Laminar Airflow Champer 2 MRND Logs";
  helpLabel = "Help";
  ...
  public laminarAirflowChamper2MrndForm!: FormGroup;
...
//  constructor(public fb: FormBuilder,private router:Router, public csService: DataService) { 
  ...
  reactiveForm() {
    this.laminarAirflowChamper2MrndForm = this.fb.group({
...
//      password: ['', [Validators.required, Validators.minLength, Validators.maxLength]],
  ...
  public  errorMessage(control: string, msg : string): string {
    const form: FormControl = (this.laminarAirflowChamper2MrndForm.controls[control] as FormControl);
 ...
 save(): void{
  console.log(this.laminarAirflowChamper2MrndForm.value);
