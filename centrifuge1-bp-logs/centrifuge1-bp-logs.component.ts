...
@Component({
  selector: 'app-centrifuge1-bp-logs',
  templateUrl: './centrifuge1-bp-logs.component.html',
  styleUrls: ['./centrifuge1-bp-logs.component.css']
})
export class Centrifuge1BpLogsComponent implements OnInit
{
  dateLabel = "Date";
  ...
  centrifuge1BpHeadingLabel = "Primas Centrifuge 1 BP Logs";
  helpLabel = "Help";
  ...
  public centrifuge1BpForm!: FormGroup;
...
//  constructor(public fb: FormBuilder,private router:Router, public csService: DataService) { 
  ...
  reactiveForm() {
    this.centrifuge1BpForm = this.fb.group({
...
//      password: ['', [Validators.required, Validators.minLength, Validators.maxLength]],
  ...
  public  errorMessage(control: string, msg : string): string {
    const form: FormControl = (this.centrifuge1BpForm.controls[control] as FormControl);
 ...
 save(): void{
  console.log(this.centrifuge1BpForm.value);
