...
@Component({
  selector: 'app-weighing-balance1-bp-logs',
  templateUrl: './weighing-balance1-bp-logs.component.html',
  styleUrls: ['./weighing-balance1-bp-logs.component.css']
})
export class WeighingBalance1BpLogsComponent implements OnInit
{
  dateLabel = "Date";
  ...
  weighingBalance1BpHeadingLabel = "Primas Weighing Balance 1 BP";
  helpLabel = "Help";
  ...
  public weighingBalance1BpForm!: FormGroup;
...
//  constructor(public fb: FormBuilder,private router:Router, public csService: DataService) { 
  ...
  reactiveForm() {
    this.weighingBalance1BpForm = this.fb.group({
...
//      password: ['', [Validators.required, Validators.minLength, Validators.maxLength]],
  ...
  public  errorMessage(control: string, msg : string): string {
    const form: FormControl = (this.weighingBalance1BpForm.controls[control] as FormControl);
 ...
 save(): void{
  console.log(this.weighingBalance1BpForm.value);
