...
@Component({
  selector: 'app-incubator1-mrnd-logs',
  templateUrl: './incubator1-mrnd-logs.component.html',
  styleUrls: ['./incubator1-mrnd-logs.component.css']
})
export class Incubator1MrndLogsComponent implements OnInit
{
  dateLabel = "Date";
  ...
  incubator1MrndHeadingLabel = "Primas Incubator 1 MRND Logs";
  helpLabel = "Help";
  ...
  public incubator1MrndForm!: FormGroup;
...
//  constructor(public fb: FormBuilder,private router:Router, public csService: DataService) { 
  ...
  reactiveForm() {
    this.incubator1MrndForm = this.fb.group({
...
//      password: ['', [Validators.required, Validators.minLength, Validators.maxLength]],
  ...
  public  errorMessage(control: string, msg : string): string {
    const form: FormControl = (this.incubator1MrndForm.controls[control] as FormControl);
 ...
 save(): void{
  console.log(this.incubator1MrndForm.value);
