...
@Component({
  selector: 'app-microscope2-bp-logs',
  templateUrl: './microscope2-bp-logs.component.html',
  styleUrls: ['./microscope2-bp-logs.component.css']
})
export class Microscope2BpLogsComponent implements OnInit
{
  dateLabel = "Date";
  ...
  microscope2BpHeadingLabel = "Primas Microscope 2 BP Logs";
  helpLabel = "Help";
  ...
  public microscope2BpForm!: FormGroup;
...
//  constructor(public fb: FormBuilder,private router:Router, public csService: DataService) { 
  ...
  reactiveForm() {
    this.microscope2BpForm = this.fb.group({
      ...
      purity: ['', [Validators.required, Validators.minLength, Validators.maxLength]],
...
//      password: ['', [Validators.required, Validators.minLength, Validators.maxLength]],
  ...
  public  errorMessage(control: string, msg : string): string {
    const form: FormControl = (this.microscope2BpForm.controls[control] as FormControl);
 ...
 save(): void{
  console.log(this.microscope2BpForm.value);
