...
@Component({
  selector: 'app-qc-microbiology-water-testing-record',
  templateUrl: './qc-microbiology-water-testing-record.component.html',
  styleUrls: ['./qc-microbiology-water-testing-record.component.css']
})
export class QcMicrobiologyWaterTestingRecordComponent  implements OnInit
{
  ...
  qcMicrobiologyWaterTestingRecordHeadingLabel = "Primas QC Microbiology Water Testing Record";
  helpLabel = "Help";
  ...
  public qcMicrobiologyWaterTestingRecordForm!: FormGroup;
...
//  constructor(public fb: FormBuilder,private router:Router, public csService: DataService) { 
  ...
  reactiveForm() {
    this.qcMicrobiologyWaterTestingRecordForm = this.fb.group({
...
//      password: ['', [Validators.required, Validators.minLength, Validators.maxLength]],
  ...
  public  errorMessage(control: string, msg : string): string {
    const form: FormControl = (this.qcMicrobiologyWaterTestingRecordForm.controls[control] as FormControl);
  ...
  save(): void{
    console.log(this.qcMicrobiologyWaterTestingRecordForm.value);
