...
@Component({
  selector: 'app-qc-microbiology-oil-testing-record',
  templateUrl: './qc-microbiology-oil-testing-record.component.html',
  styleUrls: ['./qc-microbiology-oil-testing-record.component.css']
})
export class QcMicrobiologyOilTestingRecordComponent implements OnInit
{
  ...
  qcMicrobiologyOilTestingRecordHeadingLabel = "Primas QC Microbiology Oil Testing Record";
  helpLabel = "Help";
  ...
  public qcMicrobiologyOilTestingRecordForm!: FormGroup;
...
//  constructor(public fb: FormBuilder,private router:Router, public csService: DataService) { 
  ...
  reactiveForm() {
    this.qcMicrobiologyOilTestingRecordForm = this.fb.group({
...
//      password: ['', [Validators.required, Validators.minLength, Validators.maxLength]],
  ...
  public  errorMessage(control: string, msg : string): string {
    const form: FormControl = (this.qcMicrobiologyOilTestingRecordForm.controls[control] as FormControl);
  ...
  save(): void{
    console.log(this.qcMicrobiologyOilTestingRecordForm.value);
