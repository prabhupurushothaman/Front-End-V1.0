...
@Component({
  selector: 'app-fume-hood-crnd-logs',
  templateUrl: './fume-hood-crnd-logs.component.html',
  styleUrls: ['./fume-hood-crnd-logs.component.css']
})
export class FumeHoodCrndLogsComponent implements OnInit
{
  dateLabel = "Date";
  ...
  sampleLabel = "Sample";
  onTimeLabel = "On Time";
  offTimeLabel = "Off Time";
  purposeOrRemarksLabel = "Purpose/Remarks";
  employeeCodeLabel = "Employee Code";
  fumeHoodCrndHeadingLabel = "Primas Fume Hood CRND Logs";
  helpLabel = "Help";
  ...
  public fumeHoodCrndForm!: FormGroup;
...
//  constructor(public fb: FormBuilder,private router:Router, public csService: DataService) { 
  ...
  reactiveForm() {
    this.fumeHoodCrndForm = this.fb.group({
      ...
      onTime: ['', [Validators.required, Validators.minLength, Validators.maxLength]],
      offTime: ['', [Validators.required, Validators.minLength, Validators.maxLength]],
...
//      password: ['', [Validators.required, Validators.minLength, Validators.maxLength]],
  ...
  public  errorMessage(control: string, msg : string): string {
    const form: FormControl = (this.fumeHoodCrndForm.controls[control] as FormControl);
 ...
 save(): void{
  console.log(this.fumeHoodCrndForm.value);
