...
@Component({
  selector: 'app-shaker2-bp-logs',
  templateUrl: './shaker2-bp-logs.component.html',
  styleUrls: ['./shaker2-bp-logs.component.css']
})
export class Shaker2BpLogsComponent implements OnInit
{
  dateLabel = "Date";
  ...
  shaker2BpHeadingLabel = "Primas Shaker 2 BP Logs";
  helpLabel = "Help";
  ...
  public shaker2BpForm!: FormGroup;
...
//  constructor(public fb: FormBuilder,private router:Router, public csService: DataService) { 
  ...
  reactiveForm() {
    this.shaker2BpForm = this.fb.group({
...
//      password: ['', [Validators.required, Validators.minLength, Validators.maxLength]],
  ...
  public  errorMessage(control: string, msg : string): string {
    const form: FormControl = (this.shaker2BpForm.controls[control] as FormControl);
 ...
 save(): void{
  console.log(this.shaker2BpForm.value);
