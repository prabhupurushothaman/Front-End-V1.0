...
@Component({
  selector: 'app-weighing-balance2-crnd-logs',
  templateUrl: './weighing-balance2-crnd-logs.component.html',
  styleUrls: ['./weighing-balance2-crnd-logs.component.css']
})
export class WeighingBalance2CrndLogsComponent implements OnInit
{
  dateLabel = "Date";
  ...
  weighingBalance2CrndHeadingLabel = "Primas Weighing Balance 2 Crnd";
  helpLabel = "Help";
  ...
  public weighingBalance2CrndForm!: FormGroup;
...
//  constructor(public fb: FormBuilder,private router:Router, public csService: DataService) { 
  ...
  reactiveForm() {
    this.weighingBalance2CrndForm = this.fb.group({
...
//      password: ['', [Validators.required, Validators.minLength, Validators.maxLength]],
  ...
  public  errorMessage(control: string, msg : string): string {
    const form: FormControl = (this.weighingBalance2CrndForm.controls[control] as FormControl);
 ...
 save(): void{
  console.log(this.weighingBalance2CrndForm.value);
