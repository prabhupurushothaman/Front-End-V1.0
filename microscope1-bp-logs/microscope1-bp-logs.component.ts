...
@Component({
  selector: 'app-microscope1-bp-logs',
  templateUrl: './microscope1-bp-logs.component.html',
  styleUrls: ['./microscope1-bp-logs.component.css']
})
export class Microscope1BpLogsComponent implements OnInit
{
  dateLabel = "Date";
  ...
  microscope1BpHeadingLabel = "Primas Microscope 1 BP Logs";
  helpLabel = "Help";
  ...
  public microscope1BpForm!: FormGroup;
...
//  constructor(public fb: FormBuilder,private router:Router, public csService: DataService) { 
  ...
  reactiveForm() {
    this.microscope1BpForm = this.fb.group({
...
//      password: ['', [Validators.required, Validators.minLength, Validators.maxLength]],
  ...
  public  errorMessage(control: string, msg : string): string {
    const form: FormControl = (this.microscope1BpForm.controls[control] as FormControl);
 ...
 save(): void{
  console.log(this.microscope1BpForm.value);
