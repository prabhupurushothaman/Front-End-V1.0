...
@Component({
  selector: 'app-stirrer1-crnd-logs',
  templateUrl: './stirrer1-crnd-logs.component.html',
  styleUrls: ['./stirrer1-crnd-logs.component.css']
})
export class Stirrer1CrndLogsComponent  implements OnInit
{
  dateLabel = "Date";
  ...
  stirrer1CrndHeadingLabel = "Primas Stirrer 1 CRND Logs";
  helpLabel = "Help";
  ...
  public stirrer1CrndForm!: FormGroup;
...
//  constructor(public fb: FormBuilder,private router:Router, public csService: DataService) { 
  ...
  reactiveForm() {
    this.stirrer1CrndForm = this.fb.group({
...
//      password: ['', [Validators.required, Validators.minLength, Validators.maxLength]],
  ...
  public  errorMessage(control: string, msg : string): string {
    const form: FormControl = (this.stirrer1CrndForm.controls[control] as FormControl);
 ...
 save(): void{
  console.log(this.stirrer1CrndForm.value);
